...
export function FlashCard({
  ...
  return (
    ...
    >
      <div
        className={cn(
          'relative w-full min-h-112.5 transition-transform duration-300 transform-style-preserve-3d cursor-pointer',
      ...
      >
        ...
        <UICard
          className="absolute inset-0 w-full min-h-112.5 flex flex-col backface-hidden p-6"
        ...
        >
          ...
          <div className="flex-1 flex flex-col items-center justify-center overflow-y-auto max-h-80">
            {card.imageUrl && (
        ...
        <UICard
          className="absolute inset-0 w-full min-h-112.5 flex flex-col backface-hidden p-6 rotate-y-180"
          style={{
        ...
        >
          ...
          <div className="flex-1 flex flex-col items-center justify-start overflow-y-auto max-h-80 py-4 space-y-4">
